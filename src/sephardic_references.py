...
# Your text goes here (replace with actual content from PDF)
def get_list_text():
    # Text from 
    # https://jewishgen.org/databases/sephardic/SephardimComNames.html?gad_source=1&gclid=CjwKCAjwwLO_BhB2EiwAx2e-36gDn74qjkuLwSQYVk4F0Ix7TAjUwcwCWtVQAZgIVex5j8YTZXz5DhoCsJkQAvD_BwE
    text = """
    (0) Self identified
